...
| `batch.face_parameter`    | `string`        | contains requested parameters to match with API prediction **this is optional**                                                                | "face left", "face right", "face up", "face down", "face front", "eyes open", "eyes closed", "mouth open", "mouth closed" |
