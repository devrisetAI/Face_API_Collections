...
| `batch.face_parameter`    | `string`        | contains requested parameters to match with API prediction **optional**                                                                | "face left", "face right", "face up", "face down", "face front", "eyes open", "eyes closed", "mouth open", "mouth closed" |
| `batch.spoof_detection`   | `boolean`       | Specify whether to do spoof\_detection on `batch.image` or not, will default to `true` if none specified, **optional**                 | true, false                                                                                                               |
